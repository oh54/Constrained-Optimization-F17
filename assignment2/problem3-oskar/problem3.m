...
%[x_line, fval_line, lambda_line, k2, X_line] = IneqSQP_BFGS_linesearch(x_0, lambda_0, maxiter, epsilon, tau, eta);
...
while i <= n
    ...
    if i < 5
        text(X(1,i) + 0.1, X(2,i), int2str(i));  
    end
